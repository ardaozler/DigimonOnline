...
public class DigimonStats : MonoBehaviour
{
    ...
    {
        _hunger = new Urge("Hunger", 0.3f, (new SearchAction(), () => new SearchContext(owner, "Food")));
        _cleanliness = new Urge("Cleanliness", 0.1f);
        _happiness = new Urge("Happiness", 3f, (new SearchAction(), () => new SearchContext(owner, "Ball")));
    }
